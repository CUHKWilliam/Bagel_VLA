...
/dataset_rc_mm/tangwl3@xiaopeng.com/anaconda3/envs/bagel_vla/bin/accelerate launch \
    ...
    --output_dir="/dataset_rc_mm/tangwl3@xiaopeng.com/Bagel_VLA/outputs/train/act-und-gen-ratio-0-0-1_model-und_data-tok-${TOKEN_NUM}G_model-param-${MODEL_SIZE}B" \
    --policy.push_to_hub=false \
    --policy.repo_id="lerobot/pi0" \
    --eval_freq=20000000 \
    --save_freq=1000 \
    --job_name="act-und-gen-ratio-0-0-1_model-und_data-tok-${TOKEN_NUM}G_model-param-${MODEL_SIZE}B" \
    --wandb.project="exp_viual-gen-only" \
