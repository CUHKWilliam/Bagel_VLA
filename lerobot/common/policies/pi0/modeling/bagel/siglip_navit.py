...
from lerobot.common.policies.pi0.modeling.siglip.configuration_siglip import SiglipVisionConfig as _SiglipVisionConfig
from lerobot.common.policies.pi0.modeling.siglip.modeling_siglip import SiglipAttention, SiglipPreTrainedModel
...
class SiglipFlashAttention2(SiglipAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        self.out_proj = self.out_proj.to(torch.bfloat16)
